...
if {[info exists ::pl]} {
  if {$::debug} { puts [::msgcat::mc pl_alreadyload] }
} else {
  set ::pl 0
  set ::pl::socks ""
  set ::pl::authed ""
...
proc ::pl::closepl { socktoclose sockpl } {
  ...
  ::irc::send ":$::irc::nick [tok PRIVMSG] $::irc::adminchan :\00304\002PL :\003\002 $msg"
  if {$::debug} { puts $msg }
  close $socktoclose
  return
}
...
proc ::pl::control { sockpl } {
  ...
  if {$::debug} {
    ...
    if {$protected==0} {
      ...
      ::irc::send ":$::irc::nick [tok PRIVMSG] $::irc::adminchan :\00312PL <<<\002 $sockpl \002<<<\003 [join $arg]"
    }
  }
  ...
  if {$isauth} {
    switch [lindex $arg 0] {
      ...
      .rehash { ::irc::rehash ; ::irc::send ":$::irc::nick [tok PRIVMSG] $::irc::adminchan :\00304\002PL :\003\002 [::msgcat::mc cont_rehash $sockpl]"; return }
      .die { ::irc::send ":$::irc::nick [tok PRIVMSG] $::irc::adminchan :\00304\002PL :\003\002 [::msgcat::mc pl_die $sockpl]"; ::irc::shutdown $sockpl "PL die"; return }
    }
  } else {
    if {([lindex $arg 0]==".pass")} {
      if {[string equal [lindex $arg 1] $::pl::pass]} {
        ::pl::send $sockpl [::msgcat::mc pl_auth0]
        ::irc::send ":$::irc::nick [tok PRIVMSG] $::irc::adminchan :[::msgcat::mc pl_auth1 $sockpl]"
        ...
        ::irc::send ":$::irc::nick [tok PRIVMSG] $::irc::adminchan :[::msgcat::mc pl_auth2 $sockpl]"
